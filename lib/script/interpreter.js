 ...
 */
Interpreter.prototype.verify = function(scriptSig, scriptPubkey, tx, nin, flags, witness, satoshisBN) {
      ...
      case Opcode.OP_CHECKSIGVERIFY:
        {
          ...
          try {
            ...
            fSuccess = this.tx.verifySignature(sig, pubkey, this.nin, subscript, this.sigversion, this.satoshisBN, this.flags);
          } catch (e) {
      ...
      case Opcode.OP_CHECKMULTISIGVERIFY:
        {
          ...
          while (fSuccess && nSigsCount > 0) {
            ...
            try {
              sig = Signature.fromTxFormat(bufSig);
              pubkey = PublicKey.fromBuffer(bufPubkey, false);
              fOk = this.tx.verifySignature(sig, pubkey, this.nin, subscript, this.sigversion, this.satoshisBN, this.flags);
            } catch (e) {
              //invalid sig or pubkey
              fOk = false;
            }
