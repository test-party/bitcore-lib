 ...
 */
Transaction.prototype.verifySignature = function(sig, pubkey, nin, subscript, sigversion, satoshisBN, flags) {
  ...
  if (sigversion === 1) {
    ...
    if (satoshisBN) {
      ...
      satoshisBuffer = new BufferWriter().writeUInt64LEBN(satoshisBN).toBuffer();
    } else {
